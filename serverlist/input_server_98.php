...
<body>
	<h1>Server APPSITE (10.1.2.98)</h1>
	<a href="#">Back</a><br><br>
	<table border="1" cellpadding="4" cellspacing="0">
		<form action="functions/insert.php" method="POST">
			...
			<tr>			
					<td align="center"><input type="text" align="center" size="10" class="date" name="Date" readonly = "readonly" value="<?php echo date('d/m/y');?>"/>
	</td>
					...
					<td align="center"><input type="text" name="antivirus" size="4" maxlength="10" width="20px"></td>
